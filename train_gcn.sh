...
python train.py --id 2 --seed 0 --prune_k 1 --lr 0.3 --no-rnn --num_epoch 100 --pooling max --mlp_layers 2 --pooling_l2 0.003 --cuda 1 --directed 0 --lca_type 2 --dep_type 2 --dep_dim 200
python train.py --id 3 --seed 0 --prune_k 1 --lr 0.3 --no-rnn --num_epoch 100 --pooling max --mlp_layers 2 --pooling_l2 0.003 --cuda 1 --directed 0 --lca_type 2 --dep_type 1 --dep_dim 200
python train.py --id 4 --seed 0 --prune_k 1 --lr 0.3 --no-rnn --num_epoch 100 --pooling max --mlp_layers 2 --pooling_l2 0.003 --cuda 1 --directed 0 --lca_type 2 --dep_type 0 --dep_dim 200
python train.py --id 5 --seed 0 --prune_k 1 --lr 0.3 --no-rnn --num_epoch 100 --pooling max --mlp_layers 2 --pooling_l2 0.003 --cuda 1 --directed 0 --lca_type 1 --dep_type 2 --dep_dim 200
python train.py --id 6 --seed 0 --prune_k 1 --lr 0.3 --no-rnn --num_epoch 100 --pooling max --mlp_layers 2 --pooling_l2 0.003 --cuda 1 --directed 0 --lca_type 1 --dep_type 1 --dep_dim 200
python train.py --id 7 --seed 0 --prune_k 1 --lr 0.3 --no-rnn --num_epoch 100 --pooling max --mlp_layers 2 --pooling_l2 0.003 --cuda 1 --directed 0 --lca_type 1 --dep_type 0 --dep_dim 200
python train.py --id 8 --seed 0 --prune_k 1 --lr 0.3 --no-rnn --num_epoch 100 --pooling max --mlp_layers 2 --pooling_l2 0.003 --cuda 1 --directed 0 --lca_type 0 --dep_type 2 --dep_dim 200
python train.py --id 9 --seed 0 --prune_k 1 --lr 0.3 --no-rnn --num_epoch 100 --pooling max --mlp_layers 2 --pooling_l2 0.003 --cuda 1 --directed 0 --lca_type 0 --dep_type 1 --dep_dim 200
python train.py --id 10 --seed 0 --prune_k 1 --lr 0.3 --no-rnn --num_epoch 100 --pooling max --mlp_layers 2 --pooling_l2 0.003 --cuda 1 --directed 0 --lca_type 0 --dep_type 0 --dep_dim 200
...
python train.py --id 20 --seed 0 --prune_k 1 --lr 0.3 --no-rnn --num_epoch 100 --pooling max --mlp_layers 2 --pooling_l2 0.003 --cuda 1 --directed 0 --lca_type 2 --dep_dim 0
python train.py --id 21 --seed 0 --prune_k 1 --lr 0.3 --no-rnn --num_epoch 100 --pooling max --mlp_layers 2 --pooling_l2 0.003 --cuda 1 --directed 0 --lca_type 1 --dep_dim 0
python train.py --id 22 --seed 0 --prune_k 1 --lr 0.3 --no-rnn --num_epoch 100 --pooling max --mlp_layers 2 --pooling_l2 0.003 --cuda 1 --directed 0 --lca_type 0 --dep_dim 0
