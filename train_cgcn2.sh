...
# for relation_subs2
#python train.py --id 312 --seed 0 --prune_k 1 --lr 0.3 --rnn_hidden 200 --num_epoch 100 --pooling max --mlp_layers 2 --pooling_l2 0.003 --cuda 2 --self_loop 1 --lca_type 2 --dep_type 3 --dep_dim 100 --use_processed 0 --pre_denom 1
#python eval.py saved_models/312 --cuda 2 --seed 0

## relation_subs
#python train.py --id 313 --seed 0 --prune_k 1 --lr 0.3 --rnn_hidden 200 --num_epoch 100 --pooling max --mlp_layers 2 --pooling_l2 0.003 --cuda 2 --self_loop 1 --lca_type 2 --dep_type 3 --dep_dim 100 --use_processed 0 --pre_denom 1
#python eval.py saved_models/313 --cuda 2 --seed 0

# relation_subs
python train.py --id 318 --seed 1 --prune_k 1 --lr 0.3 --rnn_hidden 200 --num_epoch 100 --pooling max --mlp_layers 2 --pooling_l2 0.003 --cuda 1 --self_loop 1 --lca_type 2 --dep_type 3 --dep_dim 100 --use_processed 0 --pre_denom 1
python eval.py saved_models/318 --cuda 1 --seed 1
